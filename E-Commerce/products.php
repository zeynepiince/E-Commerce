...
// Section products (for Best Sellers, On Sale, Recommended)
...
<div class="products-page">
  <header class="products-header">
    <h1 class="products-title"><?= $selectedCategory ? htmlspecialchars($selectedCategory, ENT_QUOTES, 'UTF-8') : 'Our Products' ?></h1>
    <p class="products-subtitle"><?= $selectedCategory ? 'Browse <strong>' . htmlspecialchars($selectedCategory, ENT_QUOTES, 'UTF-8') . '</strong> from our collection.' : 'Discover our <strong>curated</strong> collection of fashion, tech, and lifestyle essentials.' ?></p>
  </header>
  ...
  <form method="get" class="products-toolbar">
    <div class="products-filters">
      <div class="products-filter-group">
        ...
        <select name="category" id="category" class="products-select">
  ...
  <?php if (!$selectedCategory && !$minPrice && !$maxPrice): ?>
  <section class="products-section">
    <h2 class="products-section-title">Best Sellers</h2>
    <div class="products-grid products-grid--compact">
      <?php foreach ($bestSellers as $idx => $product): ?>
  ...
  <section class="products-section">
    <h2 class="products-section-title">On Sale</h2>
    <div class="products-grid products-grid--compact">
      <?php foreach ($onSale as $idx => $product): ?>
  ...
  <section class="products-section">
    <h2 class="products-section-title">Recommended for you</h2>
    <div class="products-grid products-grid--compact">
      <?php foreach ($recommended as $idx => $product): ?>
